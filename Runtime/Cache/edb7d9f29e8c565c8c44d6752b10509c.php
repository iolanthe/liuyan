...
<?php if(is_array($liuyans)): $i = 0; $__LIST__ = $liuyans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$liuyan1): $mod = ($i % 2 );++$i;?><p><?php echo ($liuyan1['cutime']); ?></p>
<p><?php echo ($liuyan1['message']); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
</div>
</body>
</html>